      ...
      <div className="container py-12 lg:pb-16">
        <div className="flex flex-wrap">
          <div className="w-full pb-8 md:pb-0">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-5" action="/thanks" name="purchase" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
              <input type="hidden" name="form-name" value="purchase" />
                ...
                <button className="bg-blue hover:bg-teal text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-4" type="submit">Request Quote</button>
            </form>
          </div>
        </div>
      </div>
