  ...
  <Layout>
    <SiteMetadata title="Get One" description="Purchase form" />
      <section className="container flex flex-wrap w-full py-6">
        ...
        <form className="bg-grey shadow-md rounded-lg px-8 pt-6 pb-8 mb-4 mt-5 w-full" name="purchase" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
